...
import com.budiardian.bidan.DetailListGetKeluhanActivity
...
//                .into(itemView.imgkeluhan)
            itemView.setOnClickListener{
                var intent= Intent(itemView.context, DetailListGetKeluhanActivity::class.java)
                intent.putExtra(DetailListGetKeluhanActivity.EXTRA_KELUHAN, mData)
                intent.putExtra("id_jeniskeluhan",mData?.idJeniskeluhan)
